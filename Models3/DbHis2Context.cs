...
public partial class DbHis2Context : DbContext
{
    ...
    public virtual DbSet<ExamenView> ExamenViews { get; set; }

    public virtual DbSet<ExamenView2> ExamenView2s { get; set; }
    ...
    public virtual DbSet<LaboratorioGetView> LaboratorioGetViews { get; set; }

    public virtual DbSet<SolicitudDetalleView> SolicitudDetalleViews { get; set; }

    public virtual DbSet<SolicitudView> SolicitudViews { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<LaboratorioGetView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("LaboratorioGetView", "dbo");
        ...
        modelBuilder.Entity<SolicitudDetalleView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("SolicitudDetalleView", "dbo");

            entity.Property(e => e.Contraste)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("CONTRASTE");
            entity.Property(e => e.CtaCorriente).HasColumnName("CTA. CORRIENTE");
            entity.Property(e => e.CódPaciente).HasColumnName("CÓD. PACIENTE");
            entity.Property(e => e.Descrip)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("DESCRIP.");
            entity.Property(e => e.DescripId).HasColumnName("DESCRIP. ID");
            entity.Property(e => e.DetalleSolId).HasColumnName("DETALLE SOL. ID");
            entity.Property(e => e.DxsId).HasColumnName("DXS ID");
            entity.Property(e => e.ExamenContrasteId).HasColumnName("EXAMEN CONTRASTE ID");
            entity.Property(e => e.ExamenLateralidadId).HasColumnName("EXAMEN LATERALIDAD ID");
            entity.Property(e => e.Fecha)
                .HasMaxLength(4000)
                .HasColumnName("FECHA");
            entity.Property(e => e.Funda)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("FUNDA.");
            entity.Property(e => e.FundaId).HasColumnName("FUNDA. ID");
            entity.Property(e => e.FxsId).HasColumnName("FXS ID");
            entity.Property(e => e.Lateralidad)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("LATERALIDAD");
            entity.Property(e => e.NombreExamen)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("NOMBRE EXAMEN");
            entity.Property(e => e.SolId).HasColumnName("SOL. ID");
        });

        modelBuilder.Entity<SolicitudView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("SolicitudView", "dbo");
            ...
            entity.Property(e => e.DetalleSolicitudId).HasColumnName("DETALLE SOLICITUD ID");
            entity.Property(e => e.Fecha)
                .HasMaxLength(4000)
                .HasColumnName("FECHA");
            ...
            entity.Property(e => e.NombreExamen)
                ...
                .IsUnicode(false)
                .HasColumnName("NOMBRE EXAMEN");
            entity.Property(e => e.SolicitudId).HasColumnName("SOLICITUD ID");
        });
